...
// export default function SideBarGoods({ filters, selectedFilters, setSelectedFilters }: Props) {
...
//         <h3>Всі товари</h3>
//         <span>Фільтри</span>
//         <button onClick={handleClearAll}>Очистити всі</button>
//         <div>
//           {filters.categories.map(c => (
//             <div
//               key={c._id}
//               style={{
//                 fontWeight: selectedFilters.category === c._id ? 'bold' : 'normal',
//                 cursor: 'pointer'
//               }}
...
//               <input
//                 type="radio"
//                 checked={selectedFilters.gender === g.value}
